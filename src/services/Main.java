...
public class Main {
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        Author a1 = new Author("Liviu", "Rebreanu", "27-Nov-1885","01-Sep-1944", "was a romanian novelist - playwright and journalist", 3.0);
        Author a2 = new Author("Ion", "Creanga", "01-Mar-1837", "31-Dec-1889", "was a romanian writer - raconteur and schoolteacher", 4.2);
        Author a3 = new Author("Mircea", "Cartarescu", "01-Jun-1956", null, "is a romanian novelist - poet - literary critic", 3.8);
        Author a4 = new Author("George S", "Clason", "07-Nov-1874","07-Apr-1957", "was an american author", 4.1);
        Author a5 = new Author("Dale", "Carnegie", "24-Nov-1888","01-Nov-1955", "was an american writer and lecturer", 4.7);
        Author a6 = new Author("J.K.", "Rowling", "31-Jul-1965", null, "is a british author and philanthropist", 5.0);
        Author a7 = new Author("Mihai", "Eminescu", "15-Jan-1850","15-Jun-1889", "was the most famous and influential Romanian poet", 4.7);
        ...
        Book b4 = new PublishedEdition("Secretele Sucesului", a5, "dezvoltare personala", 4.8, true, "delfinul de aur", 237, "1936");
        ...
        BorrowedBook bb1 = new BorrowedBook(b1, "12-Aug-2020", "13-Oct-2020");
        BorrowedBook bb2 = new BorrowedBook(b4, "05-Jan-2020", null);
        BorrowedBook bb3 = new BorrowedBook(b2, "07-Mar-2021", null);
        BorrowedBook bb4 = new BorrowedBook(b3, "23-Dec-2020", "10-Oct-2021");
        BorrowedBook bb5 = new BorrowedBook(b5, "31-Mar-2019", null);
        BorrowedBook bb6 = new BorrowedBook(b6, "12-Aug-2018", null);
        BorrowedBook bb7 = new BorrowedBook(b7, "03-Dec-2020", "15-Dec-2020");
        BorrowedBook bb8 = new BorrowedBook(b8, "22-Jul-2019", "18-Sep-2019");
        ...
        Subscription s1 = new Subscription("10-Apr-2021", "10-May-2021", r1, l1, null, audioBookList);
        Subscription s2 = new Subscription("17-Mar-2020", "17-Apr-2020", r2, l2, ebookList, null);
        Subscription s3 = new Subscription("28-May-2020", "28-Jun-2020", r3, l3, null, null);
        Subscription s4 = new Subscription("23-Sep-2019", "23-Oct-2019", r4, l4, null, audioBookList);
        Subscription s5 = new Subscription("03-Mar-2021", "03-Apr-2021", r5, l5, ebookList, audioBookList);
