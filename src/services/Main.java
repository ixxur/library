...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Author a1 = new Author("Liviu", "Rebreanu", "27", "november", "1885", "1", "september", "1944", "was a romanian novelist, playwright and journalist", 3.0);
        Author a2 = new Author("Ion", "Creanga", "1", "martie", "1837", "31", "decembrie", "1889", "was a romanian writer, raconteur and schoolteacher", 4.2);
        Author a3 = new Author("Mircea", "Cartarescu", "1", "june", "1956", null, null, null, "is a romanian novelist, poet, literary critic", 3.8);
        Author a4 = new Author("George S", "Clason", "7", "november", "1874", "7", "april", "1957", "was an american author", 4.1);
        Author a5 = new Author("Dale", "Carnegie", "24", "november", "1888", "1", "november", "1955", "was an american writer and lecturer", 4.7);
        Author a6 = new Author("J.K.", "Rowling", "31", "july", "1965", null, null, null, "is a britidh author and philanthropist", 5.0);
        Author a7 = new Author("Mihai", "Eminescu", "15", "january", "1850", "15", "june", "1889", "was the most famous and influential Romanian poet", 4.7);
        ...
        Book b2 = new Ebook("Amintiri din copilarie", a2, "autobiografie", 4.5, true, "www.amintiri.ro", 25.99, 89);
        Book b3 = new AudioBook("Travesti", a3, "jurnal", 3.9, false, "www.travesti.ro", 27.89, 200, 3.7);
        Book b4 = new PublishedEdition("Secretele Sucesului", a3, "dezvoltare personala", 4.8, true, "delfinul de aur", 200, "1936");
        ...
        Book b9 = new Ebook("The Art of Public Speaking", a5, "dezvoltare personala", 4.2, true, "www.dale.com", 36.00, 189);
        ...
        BorrowedBook bb1 = new BorrowedBook(b1, "12", "august", "2020", "13", "october", "2020");
        BorrowedBook bb2 = new BorrowedBook(b4, "5", "january", "2020", null, null, null);
        BorrowedBook bb3 = new BorrowedBook(b2, "7", "march", "2021", null, null, null);
        BorrowedBook bb4 = new BorrowedBook(b3, "23", "december", "2020", "10", "october", "2021");
        BorrowedBook bb5 = new BorrowedBook(b5, "31", "march", "2019", null, null, null);
        BorrowedBook bb6 = new BorrowedBook(b6, "12", "august", "2018", null, null, null);
        BorrowedBook bb7 = new BorrowedBook(b7, "3", "december", "2020", "15", "december", "2020");
        BorrowedBook bb8 = new BorrowedBook(b8, "22", "july", "2019", "18", "september", "2019");
        BorrowedBook bb9 = new BorrowedBook(b9, "", "", "", null, null, null);
        BorrowedBook bb10 = new BorrowedBook(b10, "", "", "", null, null, null);
        ...
        Subscription s1 = new Subscription("10", "april", "2021", "10", "may", "2021", r1, l1, null, audioBookList);
        Subscription s2 = new Subscription("17", "march", "2020", "17", "april", "2020", r2, l2, ebookList, null);
        Subscription s3 = new Subscription("28", "may", "2020", "28", "june", "2020", r3, l3, null, null);
        Subscription s4 = new Subscription("23", "september", "2019", "23", "october", "2019", r4, l4, null, audioBookList);
        Subscription s5 = new Subscription("3", "march", "2021", "3", "april", "2021", r5, l5, ebookList, audioBookList);
        ...
        Collections.sort(publsihedList, new SortByYear());
        for (int i = 0; i < publsihedList.size(); i++) {
            //  System.out.println(publsihedList.get(i).getTitle() + " by " + publsihedList.get(i).getAuthor() + " " + publsihedList.get(i).getPublishingYear());
        }
